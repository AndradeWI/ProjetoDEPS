    ...
    <div class="col-md-6 col-md-offset-2">
        ...
        <div class="row">
            <form method="post" action="/categoria/cadastro/store">
                ...
                <div class="form-group">
                    <label for="descricao">Dscrição</label><span
                            style="color:#f00;"><?php echo form_error('descricao') ?: ''; ?></span>
                    <textarea name="descricao" id="descricao"
                              class="form-control"/><?= set_value('descricao') ?: (isset($descricao) ? $descricao : ''); ?></textarea>
                </div>
